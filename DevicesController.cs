...
namespace Remotely.Server.API
{
    ...
    public class DevicesController : ControllerBase
    {
        ...
        public DevicesController(IDataService dataService, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public IEnumerable<Device> Get()
        {
            ...
            var deviceID = _session.GetString("DeviceID");
            if (deviceID != null)
            {
                var data = DataService.GetDeviceList(orgID, deviceID);
                return data;
            }          
            return null;
        }
