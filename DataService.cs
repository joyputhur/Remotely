...
namespace Remotely.Server.Services
{
    ...
    public interface IDataService
    {
        ...
        IEnumerable<Device> GetDeviceList(string orgID, string deviceID);
    ...
    public class DataService : IDataService
    {
        ...
        public IEnumerable<Device> GetDeviceList(string orgID, string deviceID)
        {
            return _dbContext.Devices.Where(x =>
                            x.OrganizationID == orgID &&
                            x.ID == deviceID);
        }
